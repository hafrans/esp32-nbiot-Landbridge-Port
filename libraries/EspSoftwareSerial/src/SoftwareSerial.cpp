...
void IRAM_ATTR SoftwareSerial::preciseDelay(uint32_t deadline, bool asyn, uint32_t savedPS) {
...
size_t IRAM_ATTR SoftwareSerial::write(const uint8_t * buffer, size_t size) {
	if (m_rxValid) { rxBits(); }
